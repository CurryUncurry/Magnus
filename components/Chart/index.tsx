import { Box, CircularProgress, Skeleton, Text } from '@chakra-ui/react'
		...
		<Box style={{ width: '100%', height: '100%' }}>
			<div className="chart-card-header">
				...
				{loading ? (
					...
					<Box display="flex">
						<Text variant="h4" style={{ fontWeight: 600, marginRight: 5 }}>
							{headerSubText}
						</Text>
						<Text variant="h4" color="textSecondary" style={{ fontWeight: 400 }}>
							{type !== 'multi' && `Today`}
						</Text>
					</Box>
				)}
